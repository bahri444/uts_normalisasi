            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <img src="/logo/logo_kampus.png" width="30px" alt="404">
                        </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item">
                            <a href="/bagian" class='sidebar-link'>
                        ...
                        <li class="sidebar-item">
                            <a href="/kebutuhan" class='sidebar-link'>
                                <i class="fab fa-uncharted"></i>
                                <span>Kebutuhan</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="/administrasi" class='sidebar-link'>
                                <i class="fas fa-money-check-alt"></i>
                                <span>Administrasi</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="/penanggungjawab" class='sidebar-link'>
                                <i class="fas fa-users"></i>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <p class="footer-text m-0">
                                            ...
                                            All rights reserved | <span class="text-danger"></span> by <a href="#">Aolia Musofa</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
